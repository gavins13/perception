...
def init_conv_2d(input_images, num_f_maps, kernel_size=5):
...
def convolutional_capsule_layer(input_tensor, kernel_height, kernel_width,
output_kernel_vec_dim=8, strides=[1, 1],
