...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer6 = depthwise_convolutional_capsule_layer(layer1b, 9,9, "DepthConv5_red", strides=[1,1], num_output_channels=16, upsampling_factor=None, type="SAME", conv_vector=True)
        layer7 = convolutional_capsule_layer_v2(layer6, 5,5,'ConvCaps1',output_kernel_vec_dim=8,  num_output_channels=4, strides=[1,1], type="SAME")

        layer14 = tf.transpose(layer7, [0,3,4,1,2])
