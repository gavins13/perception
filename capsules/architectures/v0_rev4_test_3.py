...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer2 = depthwise_convolutional_capsule_layer(layer1b, 5,5, "DepthConv1", strides=[1,1], num_output_channels=16, upsampling_factor=None, type="SAME", conv_vector=False)

        layer3 = depthwise_convolutional_capsule_layer(layer2, 9,9, "DepthConv2_red", strides=[2,2], num_output_channels=32, upsampling_factor=None, type="SAME", conv_vector=False)

        layer4 = depthwise_convolutional_capsule_layer(layer3, 5,5, "DepthConv3", strides=[1,1], num_output_channels=32, upsampling_factor=None, type="SAME", conv_vector=False)
        ...
        layer6 = depthwise_convolutional_capsule_layer(layer5, 5,5, "DepthConv5_red", strides=[2,2], num_output_channels=8, upsampling_factor=None, type="SAME", conv_vector=False)

        layer7 = depthwise_convolutional_capsule_layer(layer6, 5,5, "DepthConv5.5", strides=[1,1], num_output_channels=8, upsampling_factor=None, type="SAME", conv_vector=False)
        ...
        layer14 = tf.transpose(layer13, [0,3,4,1,2])
