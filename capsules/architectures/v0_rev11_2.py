...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        for i in range(1):
            layer2 = tf.layers.conv2d(layer2, 256, 1, padding='same', name='PrimaryCapsReduce.2'+str(i), activation=tf.nn.sigmoid)
        # [batch, 8,8, 512]
        ...
        output = tf.layers.conv2d(output, 1, 1, strides=(1,1), padding='same', name="endingfinal4", activation=tf.nn.sigmoid)
