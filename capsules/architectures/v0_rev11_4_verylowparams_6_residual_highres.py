...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer3 = convolutional_capsule_layer_v2(layer2,1,1,'ConvCaps1',output_kernel_vec_dim=16,  num_output_channels=1, strides=[1,1], type="SAME", num_routing=4, use_matrix_bias=False)
        ...
        output = tf.layers.conv2d(output, 1, 1, strides=(1,1), padding='same', name="thefinaloutput."+str(4), activation=tf.nn.relu)
        output = tf.squeeze(output, axis=3)
