...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer15 =tf.layers.conv2d(layer15, 64, 27, strides=(1,1), padding='same', name="red2")
        layer15 = tf.nn.relu(layer15)
        layer15 =tf.layers.conv2d(layer15, 64, 13, strides=(1,1), padding='same', name="red3")
        layer15 = tf.nn.relu(layer15)
        layer15 =tf.layers.conv2d(layer15, 64, 9, strides=(1,1), padding='same', name="red4")
        layer15 = tf.nn.relu(layer15)
        for i in range(6,40):
            layer15 =tf.layers.conv2d(layer15, 128, 7, strides=(1,1), padding='same', name="red"+str(i))
            layer15 = tf.nn.relu(layer15)
