...
# 0v,12,3  (2->3) => Remove end conv bias, make initial conv deep and remove squash bias
    ...
    def build(self, input_images):
        ...
        with tf.device('/cpu:0'):
            with tf.name_scope('output_addition'):
                ...
                weight_2 = tf.get_variable('weight2',[1],initializer=tf.constant_initializer(3.), dtype=tf.float32, trainable=True)
