...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer2 = depthwise_convolutional_capsule_layer(layer1b, 25,25, "InitCaps", strides=[1,1], num_output_channels=2, upsampling_factor=None, type="SAME", conv_vector=True)
        #layer2 = tf.norm(layer2, axis=1, keepdims=True)

        '''layer11 = convolutional_capsule_layer_v2(layer2,5,5,'ConvCaps7',output_kernel_vec_dim=16,  num_output_channels=4, strides=[1,1], type="SAME")
        ...
        layer15 = convolutional_capsule_layer_v2(layer2, 7,7,'ConvCaps10',output_kernel_vec_dim=1,  num_output_channels=1, strides=[1,1], type="SAME")
