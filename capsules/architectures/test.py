...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer1 = init_conv_2d(input_images, 20, "Init", kernel_size=9)
        print(layer1.get_shape().as_list())
        print(">>>>> Initial Convolution Capsule")
        layer2 = convolutional_capsule_layer(layer1, 9,9,'ConvCaps',output_kernel_vec_dim=8,convolve_across_channels=True,    num_output_channels=10, kernel_is_vector=False)
        ...
        print(">>>>> Routing 1")
        layer2b = patch_based_routing(layer2,"primaryrouting", patch_shape=[1,5,5])
        ...
        print(">>>>> Routing 2")
        layer3b = routing(layer3, "digitrouting", output_dimensions=[10,1,1],    bias_channel_sharing=True) # [batch, 16, num_ch, height, width] is equal to  [b,16,10,1,1]
