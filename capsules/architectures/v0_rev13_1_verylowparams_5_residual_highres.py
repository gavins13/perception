...
#0v,13,1, 2 -> 5 => Simply change the output from weighted addition, to simple addition
...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer3 = convolutional_capsule_layer_v2(layer2,1,1,'ConvCaps1',output_kernel_vec_dim=4,  num_output_channels=4, strides=[1,1], type="SAME", num_routing=3, use_matrix_bias=True, use_squash_bias=True)
