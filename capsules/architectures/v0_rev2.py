...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer14 = depthwise_convolutional_capsule_layer(layer13, 5,5, "DepthConv10", strides=[1,1], num_output_channels=16, upsampling_factor=1., type="SAME", conv_vector=False, relu=True)
        ...
        layer16 = tf.layers.conv2d(layer14, 64, 1, padding='same', name="End1")
        layer17 = tf.nn.relu(layer16, name="End2")
        layer18 = tf.layers.conv2d(layer17, 128, 1, padding='same', name='End3')
    ...
    def loss_func(self, input_images, ground_truth):
        ...
        with tf.name_scope('accuracy'):
            ...
            tf.summary.image('first_image', tf.expand_dims(tf.slice(output, [0,0,0], [1, -1,-1]), axis=3) )
