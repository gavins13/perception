...
class architecture(object):
    ...
    def build(self, input_images):
        ...
        layer2 = layer1
        layer2 = tf.layers.conv2d(layer2, 64, 9, padding='same', name='linear_conv', activation=None)
        # [batch, 128,128, 256]
        ...
        output = tf.layers.conv2d(output, 1, 1, strides=(1,1), padding='same', name="thefinaloutput."+str(4), activation=None) # ReLU ?
        output = tf.squeeze(output, axis=3)
