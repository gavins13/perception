...
# Command for running:
# docker run -it --privileged -p 15050:5050 --expose 9229 -p 19229:9229 -v "/:/home/project:cached" -e "username=gavin" -e "password=18814876afd27dcea8a3ba11a1412c0f" --name theia land007/theia:latest
# moutning:
# sshfs -o allow_other -o reconnect -o ServerAliveInterval=15 kgs13@cyberdyne:/ /data/root_only/IC_CYBERDYNE_ROOT/